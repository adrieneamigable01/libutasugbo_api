...
class Business extends BD_Controller {
    ...
    public function index()
    {
        ...
        $where_business_info    = array();
        if(isset($business_id)){
            $where_business_info['business.business_id']   = $business_id;
        }
        if(isset($user_id)){
            $where_business_info['business.owner_id']     = $user_id;
        }
        if(isset($is_active)){
            $where_business_info['business.is_active']    = $is_active;
        }
        if(isset($status)){
            $where_business_info['business.status']       = $status;
        }
    ...
    public function create(){
        ...
        $uuid               = $this->uuid->guidv4('b-'.date("YmdHis"));
